...
def validate_data(values):
    """
    Inside the try, converts all string values into integers, Raises ValueError if string cannot be converted into int, or if there arent exactly 6 values.
    """
    try:
...
def calculate_surplus_data(sales_row):
    ...
    Teh surplus is defined as the sales figure subracted from the stock:
    positive surplus indicates waste,
    negative surplus indeicates extra made items when stock sold out.
    """
